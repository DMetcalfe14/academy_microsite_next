const CategoryCard = ({title, description, image, alt, count = 0, href = `search.html?category=${title}` }) => {
  return (
    <article
      ...
      <div className="p-6 gap-2 flex flex-col">
        ...
        >
          <a
            ...
            aria-label={`View all resources for category: ${title}`}
          >
            {title}
          </a>
        </h3>
        ...
        {/* Count */}
        <span class="text-primary text-sm font-semibold">{count} resources</span>
